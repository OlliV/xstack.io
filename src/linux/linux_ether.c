...
static int linux_ether_bind(struct ether_linux * eth)
{
    ...
    socket_address.sll_pkttype = PACKET_OTHERHOST | PACKET_BROADCAST |
                                 PACKET_MULTICAST | PACKET_HOST;
    ...
    bind(eth->el_fd, (struct sockaddr *)&socket_address, sizeof(socket_address));
